...
class LocationTracker private constructor(
    ...
    private val listeners = CopyOnWriteArrayList<(ru.yandex.buggyweatherapp.data.model.Location) -> Unit>()
    
    
    private val locationListener = object : LocationListener {
        override fun onLocationChanged(location: Location) {
            
            val newLocation = ru.yandex.buggyweatherapp.data.model.Location(
    ...
    fun addListener(listener: (ru.yandex.buggyweatherapp.data.model.Location) -> Unit) {
        listeners.add(listener)
    }
    
    private fun notifyListeners(location: ru.yandex.buggyweatherapp.data.model.Location) {
